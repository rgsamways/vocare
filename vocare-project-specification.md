...
4. ~~Confirm Expo vs. fully native Android~~ — **superseded by Section 2's Mobile row:** the real open decision is Expo-with-separate-Vite-web vs. unified React Native Web, now made an explicit M0 task rather than a background assumption
